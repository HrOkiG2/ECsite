        ...
        <div class="pickup_cotent_box">
            <div class="pickup_content">
                ...
                <div class="product_parts">
                    <h3 class="pickup_h3">{{$pickup->product_name}}</h3>
                    <p class="pickup_detail">{{$pickup->detail}}</p>
                    <p class="price">{{$pickup->price}}円</p>
                </div>
            </div>
            <div class="pickup_button">
                ...
                <form action="/detail" method="POST">
                    @csrf   
                    <button type="submit" value="{{$pickup->product_id}}" name="product_detail" class="product_detail">
                        商品の詳細を見る
                    </button>
                </form>
        ...
        <div class="product_card">
            ...
            <form action="/detail" method="POST">
                ...
                <div class="product_button_box">
                    <button type="submit" value="{{$pickup->product_id}}" name="product_detail" class="product_button">
                        商品の詳細を見る
                    </button>
                </div>
            </form>
